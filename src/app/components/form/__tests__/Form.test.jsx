...
describe('Form Component', () => {
    it('renders children', () => {
        render(<Form onSubmit={() => { }} validationSchema={yup.object().shape({})}>
    ...
    it('applies default values', async () => {
        ...
        const TestComponent = () => {
            ...
            return (<Form onSubmit={handleSubmit} validationSchema={yup.object().shape({
                    name: yup.string(),
                })} defaultValues={{
                    name: 'John Doe',
                }}>
          <input data-testid="name-input" name="name" value={value} onChange={(e) => setValue(e.target.value)}/>
    ...
    it('validates form data', async () => {
        const handleSubmit = jest.fn();
        render(<Form onSubmit={handleSubmit} validationSchema={yup.object().shape({
