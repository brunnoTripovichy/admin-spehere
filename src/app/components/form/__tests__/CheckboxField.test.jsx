...
describe('CheckboxField Component', () => {
    test('renders checkbox with label', () => {
        render(<FormWrapper defaultValues={{ rememberMe: false }}>
    ...
    test('initializes with default value', () => {
        render(<FormWrapper defaultValues={{ rememberMe: true }}>
        <CheckboxField name="rememberMe" label="Remember me"/>
      </FormWrapper>);
        const checkbox = screen.getByRole('checkbox');
        expect(checkbox.checked).toBe(true);
    ...
    test('displays helper text when provided', () => {
        render(<FormWrapper defaultValues={{ rememberMe: false }}>
        <CheckboxField name="rememberMe" label="Remember me" helperText="Stay logged in for 30 days"/>
      </FormWrapper>);
    ...
    test('applies custom className', () => {
        var _a;
        render(<FormWrapper defaultValues={{ rememberMe: false }}>
        <CheckboxField name="rememberMe" label="Remember me" className="custom-class"/>
      </FormWrapper>);
