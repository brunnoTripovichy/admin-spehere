...
describe('TextField Component', () => {
    test('renders with label and placeholder', () => {
        render(<FormWrapper defaultValues={{ email: '' }}>
        <TextField name="email" label="Email Address" placeholder="Enter your email"/>
      </FormWrapper>);
    ...
    test('initializes with default value', () => {
        render(<FormWrapper defaultValues={{ email: 'initial@example.com' }}>
        <TextField name="email" label="Email Address"/>
      </FormWrapper>);
        const input = screen.getByLabelText('Email Address');
    ...
    test('displays helper text when provided', () => {
        render(<FormWrapper defaultValues={{ email: '' }}>
        <TextField name="email" label="Email Address" helperText="We'll never share your email"/>
      </FormWrapper>);
    ...
    test('applies custom className', () => {
        render(<FormWrapper defaultValues={{ email: '' }}>
        <TextField name="email" label="Email Address" className="custom-class"/>
      </FormWrapper>);
